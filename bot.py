...
def parse_wordle_result(text):
    """
    Detecta resultados de Wordle / La Palabra del Día.
    Soporta:
    - Texto con emojis de colores (🟩🟨⬛⬜)
    - Texto sin emojis: "La palabra del día #1549 3/6"
    - Cualquier mensaje con patrón X/6 que mencione wordle o palabra del día
    """
    text_lower = text.lower()

    # Detectar si es un resultado de wordle por contexto
    is_wordle_context = bool(re.search(r'[🟩🟨⬛⬜🟦🟧]', text)) or \
